...
Try {
	...
	[string]$appVendor = 'NIMH'
	[string]$appName = 'MonkeyLogic'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'matlab' -CheckDiskSpace -PersistPrompt
		...
		Copy-Item "$matlabroot\matlabrc.m" -Destination "$matlabroot\matlabrc.m.bak"
		# Add path to matlab startup file to load Monkeylogic
		Add-Content -Path "$matlabroot\matlabrc.m" -Value "addpath C:\MonkeyLogic"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'matlab' -CloseAppsCountdown 60
		...
		$matlabroot = Split-Path -Path 'C:\Program Files*\MATLAB\R20*\toolbox\local\matlabrc.m' -Resolve
		Remove-Item -Path "$matlabroot/matlabrc.m"
		Rename-Item -Path "$matlabroot/matlabrc.m.bak" -NewName "$matlabroot/matlabrc.m"
		Remove-Item -Path "C:\MonkeyLogic" -Recurse
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpQUL0f6rkrlbA
# x1mdOk1MqTam7ceRciznCPJXmFaMK6CCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgTuOtU3IC
# 4q3oORLJawaYDCpGy1Dey0UD6l70z9yMNQ0wDQYJKoZIhvcNAQEBBQAEggEAa7TV
# hnaJwW7riUyJMqaHhgIDaml6S1xMZa/TxNvqd541rgz3NKASpYHYqNrKuuATXaXH
# ecVWDEPJczmobpF4TKQkkK8dHTo1R6PVFlC94VU6zQuIcEhRte9gG20pYBha7W1+
# 0zsGucj2ypUs8h2RfXYuXJXE1r2ctMpf908NkwiJexyLfqoFDxN+qJNnqXLvII6+
# FR5UxMloYdKoSiGNyUYaIDAgt9pmec3L6m7ObsLjLZtXTuvZtn3pS7v4MTr4rBFm
# lZxCZWzCGqqoFWUizTjUvYb1eg9/4q9VLkLWYv+AmcKlT+IrSa6bLo9fDTmN1gWM
# nm4tfckUESZeLveTu6GCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA4MjExNDQ5MTVaMCMGCSqGSIb3DQEJBDEWBBRQFTPd
# gBJRnVPjVs+qbciyy2hQNzCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAWlGUHgcFgoQOyxkkeV3D5abKLhkxTAl+8UNVMGljlKqH6drJmVg2bFt2YULR
# 3XPx6gfLq8bLl3lfgvg1astxPOQfzmtS5ApLSl+AvcGWhWpCZpfpmbH3P8fVkjA4
# kWQ6vMwtDAnui8Aahm54Q5LA/MOZH3oxMkEfTGlK3pJD5OmUqqCySauLOfd1JQb3
# h5XAFtIBa7hZzkdNI1+q+jNL0VA2nuGkYT+n0bM/PtiVaMT6V+tTFxAoMZAonf28
# zcaM6jcLn93NeT9jIwvD1y0UR9P+2mkrrvGYCQ6y8KZe8qdPQvfmtF40CtcQ77tf
# nTr8BCrW2R3BWfH59TcLRPon+g==
